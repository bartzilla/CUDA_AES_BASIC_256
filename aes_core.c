...
int i = 500 ;
int __i;
#define dump(length, data) for ( __i = 0; __i < length; ++__i ) printf("%02x", (uchar)data[__i]);
#define dstate(data) printf("    - State: "); dump(16, data); printf("\n")
...
void AddRoundKey (unsigned *state, unsigned *key)
{
	...
	//printf("  - AddRoundKey\n");
	//printf("    - State: "); for ( __i = 0; __i < 4; ++__i ) //printf("%08x", state[__i]); printf("\n");
	//printf("    - Key:   "); for ( __i = 0; __i < 4; ++__i ) //printf("%08x", key[__i]); printf("\n");
...
unsigned round;
	...
	//printf("- Encrypt:\n");
	//printf("    - Initial state: "); dump(16, state); printf("\n");
	//printf("    - Initial key:   "); dump(88, expkey); printf("\n");
